import{j as p,a,c as T,F as fe,B as pe}from"./Button-tyhV8qOq.js";import{r as b}from"./index-DRjF_FHU.js";import{T as be,D as ye,S as ve,P as xe,C as we}from"./index-Qa8Xbfsz.js";import"./jsx-runtime-DiklIkkE.js";import"./iframe-BFY8FksI.js";import"./index-B7ki2Uzk.js";import"./index-FTTXbSiM.js";import"./index-DrFu-skq.js";const r=({label:e,name:l,type:t="text",value:o,onChange:n,placeholder:s,required:i=!1,error:c,disabled:y=!1,readonly:h=!1,id:ue,"data-testid":R,labelPosition:d="above",size:g="medium",autoResize:u=!1,className:m,onKeyDown:V})=>{const x=b.useRef(null),w=ue||(typeof e=="string"?`input-${e.toLowerCase().replace(/\s+/g,"-")}`:l?`input-${l}`:`input-${Math.random().toString(36).substring(2,9)}`),me=v=>{n(v)},ce=v=>{n(v),u&&x.current&&F(x.current)},F=v=>{v.style.height="auto",v.style.height=`${v.scrollHeight}px`};b.useLayoutEffect(()=>{x.current&&t==="textarea"&&(u?F(x.current):x.current.style.height="")},[o,u,t]);const M=e?p("label",{css:[f({labelPosition:d,size:g,autoResize:u}).label,m==null?void 0:m.label],htmlFor:w,children:[e,i&&a("span",{css:f({labelPosition:d,size:g,autoResize:u}).required,children:"*"})]}):null,he=t==="textarea"?a("textarea",{ref:x,id:w,name:l,value:o,onChange:ce,placeholder:s,required:i,disabled:y,readOnly:h,onKeyDown:V,"data-testid":R,css:[f({labelPosition:d,size:g,autoResize:u}).textarea,c&&f({labelPosition:d,size:g,autoResize:u}).inputError,y&&f({labelPosition:d,size:g,autoResize:u}).inputDisabled,h&&f({labelPosition:d,size:g,autoResize:u}).inputReadonly,m==null?void 0:m.input],"aria-describedby":c?`${w}-error`:void 0}):a("input",{id:w,name:l,type:t,value:o,onChange:me,placeholder:s,required:i,disabled:y,readOnly:h,"data-testid":R,onKeyDown:V,css:[f({labelPosition:d,size:g,autoResize:u}).input,c&&f({labelPosition:d,size:g,autoResize:u}).inputError,y&&f({labelPosition:d,size:g,autoResize:u}).inputDisabled,h&&f({labelPosition:d,size:g,autoResize:u}).inputReadonly,m==null?void 0:m.input],"aria-describedby":c?`${w}-error`:void 0}),ge=c?a("div",{css:[f({labelPosition:d,size:g,autoResize:u}).error,m==null?void 0:m.error],id:`${w}-error`,role:"alert",children:c}):null;return p("div",{css:[f({labelPosition:d,size:g,autoResize:u}).container,m==null?void 0:m.container],children:[(d==="above"||d==="left")&&M,he,(d==="below"||d==="right")&&M,ge]})},W=e=>{switch(e){case"large":return{padding:"0.75rem",fontSize:"1rem"};case"small":return{padding:"0.3rem",fontSize:"0.625rem"};default:return{padding:"0.5rem",fontSize:"0.875rem"}}},f=({labelPosition:e,size:l,autoResize:t,onDark:o})=>{var n,s;return{container:{display:"flex",flexDirection:e==="above"||e==="below"?"column":"row",gap:e==="left"||e==="right"?"0.75rem":"0.5rem",flex:"1 1 0%",width:"-webkit-fill-available",minWidth:0,alignItems:e==="left"||e==="right"?"center":"stretch"},label:{fontSize:"0.875rem",fontWeight:500,color:o?T.tertiary[50]:T.primary[900],display:"flex",alignItems:"center",gap:"0.25rem",marginTop:e==="below"?"0.25rem":"0",marginRight:e==="left"?"0.5rem":"0",marginLeft:e==="right"?"0.5rem":"0",alignSelf:e==="left"||e==="right"?"center":"flex-start"},required:{color:"#ef4444",fontSize:"0.875rem"},input:{...W(l),border:`1px solid ${(n=T)==null?void 0:n.tertiary[500]}`,borderRadius:"6px",transition:"all 0.2s ease",minWidth:0,"&:focus":{outline:"2px solid #3b82f6",outlineOffset:"2px",borderColor:"#3b82f6"},"&::placeholder":{color:"#9ca3af"}},textarea:{...W(l),border:`1px solid ${(s=T)==null?void 0:s.tertiary[500]}`,borderRadius:"6px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",minWidth:0,minHeight:"3rem",resize:t?"none":"vertical",overflow:t?"hidden":"auto","&:focus":{outline:"2px solid #3b82f6",outlineOffset:"2px",borderColor:"#3b82f6"},"&::placeholder":{color:"#9ca3af"}},inputError:{borderColor:"#ef4444","&:focus":{outline:"2px solid #ef4444",borderColor:"#ef4444"}},inputDisabled:{backgroundColor:"#f9fafb",color:"#6b7280",cursor:"not-allowed"},inputReadonly:{backgroundColor:"transparent",outline:"none",border:"none",cursor:"default"},error:{fontSize:"0.875rem",color:"#ef4444",marginTop:"0.25rem"}}};r.__docgenInfo={description:"",methods:[],displayName:"InputField",props:{label:{required:!1,tsType:{name:"union",raw:"string | ReactNode",elements:[{name:"string"},{name:"ReactNode"}]},description:""},name:{required:!1,tsType:{name:"string"},description:""},type:{required:!1,tsType:{name:"union",raw:`| 'text'
| 'email'
| 'password'
| 'tel'
| 'url'
...
}`,...(P=(k=C.parameters)==null?void 0:k.docs)==null?void 0:P.source}}};var j,O,$;S.parameters={...S.parameters,docs:{...(j=S.parameters)==null?void 0:j.docs,source:{originalSource:`{
  controls: {
    disable: true
  },
...
}`,...($=(O=S.parameters)==null?void 0:O.docs)==null?void 0:$.source}}};var B,Y,_;E.parameters={...E.parameters,docs:{...(B=E.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {
    autoResize: false
  },
...
}`,...(_=(Y=E.parameters)==null?void 0:Y.docs)==null?void 0:_.source}}};var K,U,J;I.parameters={...I.parameters,docs:{...(K=I.parameters)==null?void 0:K.docs,source:{originalSource:`{
...
}`,...(J=(U=I.parameters)==null?void 0:U.docs)==null?void 0:J.source}}};var G,Q,X;L.parameters={...L.parameters,docs:{...(G=L.parameters)==null?void 0:G.docs,source:{originalSource:`{
...
}`,...(X=(Q=L.parameters)==null?void 0:Q.docs)==null?void 0:X.source}}};var Z,N,ee;z.parameters={...z.parameters,docs:{...(Z=z.parameters)==null?void 0:Z.docs,source:{originalSource:`{
...
}`,...(ee=(N=z.parameters)==null?void 0:N.docs)==null?void 0:ee.source}}};var ae,te,re;q.parameters={...q.parameters,docs:{...(ae=q.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
...
}`,...(re=(te=q.parameters)==null?void 0:te.docs)==null?void 0:re.source}}};var ne,oe,le;D.parameters={...D.parameters,docs:{...(ne=D.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  args: {
    autoResize: true
  },
...
}`,...(le=(oe=D.parameters)==null?void 0:oe.docs)==null?void 0:le.source}}};var se,ie,de;A.parameters={...A.parameters,docs:{...(se=A.parameters)==null?void 0:se.docs,source:{originalSource:`{
  args: {
...
}`,...(de=(ie=A.parameters)==null?void 0:ie.docs)==null?void 0:de.source}}};const He=["Default","InputTypes","TextareaWithAutoResize","LabelPositions","SizeVariants","ErrorStates","SpecialStates","CompleteFormExample","Playground"];export{D as CompleteFormExample,C as Default,z as ErrorStates,S as InputTypes,I as LabelPositions,A as Playground,L as SizeVariants,q as SpecialStates,E as TextareaWithAutoResize,He as __namedExportsOrder,We as default};
