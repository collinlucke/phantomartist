...
const Form = ({ children, onSubmit }) => {
    ...
    return jsxRuntimeExports.jsx("form", { onSubmit: handleOnSubmit, children: children });
};

const FormInputLabel = ({ position, name, label }) => {
    switch (position) {
        case 'left':
            return jsxRuntimeExports.jsx("label", { htmlFor: name, children: label });
        case 'right':
            return jsxRuntimeExports.jsx("label", { htmlFor: name, children: label });
        case 'above':
            return (jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [jsxRuntimeExports.jsx("label", { htmlFor: name, children: label }), jsxRuntimeExports.jsx("br", {})] }));
        case 'below':
            return (jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [jsxRuntimeExports.jsx("br", {}), jsxRuntimeExports.jsx("label", { htmlFor: name, children: label })] }));
    }
};

const FormTextInput = ({ label = '', name = '', type = 'text', labelPos = 'left', value = '', onChange }) => {
    const onChangeHandler = (e) => {
        onChange?.(e);
    };
    return (jsxRuntimeExports.jsxs("div", { children: [labelPos === 'left' || labelPos === 'above' ? (jsxRuntimeExports.jsx(FormInputLabel, { position: labelPos, name: name, label: label })) : (''), jsxRuntimeExports.jsx("input", { value: value, type: type, name: name, id: name, onChange: onChangeHandler }), labelPos === 'right' || labelPos === 'below' ? (jsxRuntimeExports.jsx(FormInputLabel, { position: labelPos, name: name, label: label })) : ('')] }));
};
...
var _inject2$6 = inject;
const List = ({
  className,
  children
}) => {
  return jsxRuntimeExports.jsx("ul", {
    ...props(baseStyles$6.ul, className),
    children: children
  });
};
_inject2$6(".x-1kogg8i{border-radius:6px}", 2000);
_inject2$6(".x-5940wz{min-height:5px}", 4000);
_inject2$6(".x-k50ysn{font-weight:500}", 3000);
_inject2$6(".x-61t7lx{padding:20px 0}", 1000);
_inject2$6(".x-1ghz6dp{margin:0}", 1000);
const baseStyles$6 = {
  ul: {
    "List__baseStyles.ul": "List__baseStyles.ul",
    borderRadius: "x-1kogg8i",
...
var _inject2$5 = inject;
_inject2$5(":root{--x-l2mxze:#244855;--x-1sev75o:#E64833;--x-o6rs8s:#874F42;--x-o75t80:#FBE9D0;--x-gjmfjc:#244855;}", 0);

var _inject2$4 = inject;
const ListItem = ({
  children,
  className
}) => {
  ...
  if (children?.type.displayName === 'NavLink') {
    newChildren = React.cloneElement(children, {
      className: {
        ...props(baseStyles$5.a, className)
      }.className
    });
  }
  return jsxRuntimeExports.jsx("li", {
    ...props(baseStyles$5.li, className),
    children: newChildren || children
  });
};
_inject2$4(".x-1kogg8i{border-radius:6px}", 2000);
_inject2$4(".x-yorhqc{margin-bottom:10px}", 4000);
_inject2$4(".x-7z7khe{padding:10px}", 1000);
_inject2$4(".x-1qnaj9h{background-color:var(--x-o75t80)}", 3000);
_inject2$4(".x-1gnnqk1{box-shadow:none}", 3000);
_inject2$4(".x-86fegx:hover{box-shadow:1px 1px 3px color-mix(in srgb-linear,var(--x-o75t80) 50%,black)}", 3130, ".x-86fegx:hover{box-shadow:-1px 1px 3px color-mix(in srgb-linear,var(--x-o75t80) 50%,black)}");
_inject2$4(".x-16i28q2{color:var(--x-o6rs8s)}", 3000);
const baseStyles$5 = {
  li: {
    "ListItem__baseStyles.li": "ListItem__baseStyles.li",
    borderRadius: "x-1kogg8i",
    borderStartStartRadius: null,
    borderStartEndRadius: null,
    borderEndStartRadius: null,
    ...
    paddingTop: null,
    paddingBottom: null,
    backgroundColor: "x-1qnaj9h",
    boxShadow: "x-1gnnqk1 x-86fegx",
    $$css: true
  },
  a: {
    "ListItem__baseStyles.a": "ListItem__baseStyles.a",
    color: "x-16i28q2",
    $$css: true
  }
};
...
const Main = ({
  ...
  return jsxRuntimeExports.jsx("main", {
    ...props(baseStyles$4.page, className),
    children: children
  });
};
const baseStyles$4 = {
  page: {
    "Main__baseStyles.page": "Main__baseStyles.page",
    $$css: true
  }
};

var _inject2$3 = inject;
const InnerWidth = ({
  children,
  className
}) => {
  return jsxRuntimeExports.jsx("div", {
    ...props(baseStyles$3.base, className),
    children: children
  });
};
// const width = screenWidths.xlg;
_inject2$3(".x-1y8v6su{align-self:start}", 3000);
_inject2$3(".x-1q9ncyh{background-color:color-mix(in srgb,var(--x-l2mxze) 35%,white)}", 3000);
_inject2$3(".x-nlsq7q{width:calc(100% - 20px)}", 4000);
_inject2$3("@media  (min-width: 320px){.x-1nwtup4.x-1nwtup4{width:calc(100% - 20px)}}", 4200);
_inject2$3("@media (min-width: 420px){.x-157de73.x-157de73{width:calc(100% - 40px)}}", 4200);
_inject2$3("@media  (min-width: 780px){.x-d34295.x-d34295{width:720px}}", 4200);
_inject2$3("@media  (min-width: 1024px){.x-1j4t1d3.x-1j4t1d3{width:900px}}", 4200);
_inject2$3("@media  (min-width: 1200px){.x-klrsxl.x-klrsxl{width:1024px}}", 4200);
_inject2$3(".x-xmtint{padding:0 20px}", 1000);
const baseStyles$3 = {
  base: {
    "InnerWidth__baseStyles.base": "InnerWidth__baseStyles.base",
    alignSelf: "x-1y8v6su",
    backgroundColor: "x-1q9ncyh",
    width: "x-nlsq7q x-1nwtup4 x-157de73 x-d34295 x-1j4t1d3 x-klrsxl",
    padding: "x-xmtint",
    paddingInline: null,
    paddingStart: null,
    paddingLeft: null,
...
var _inject2$2 = inject;
let newChildren;
const useModifiedChildren = (element, className) => {
  const child = element.element;
  if ((!!child.props.children || child.props.children.length) && React.isValidElement(child.props.children)) {
    ...
    if (typeof child.type === 'object' && child.type.displayName === 'NavLink') {
      newChildren = React.cloneElement(child, {
        className: {
          ...props(baseStyles$2.a, className)
        }.className
      });
    }
    useModifiedChildren({
...
_inject2$2(".x-831fxd{color:var(--x-1sev75o)}", 3000);
_inject2$2(".x-1hl2dhg{text-decoration:none}", 2000);
const baseStyles$2 = {
  a: {
    "useModifiedChildren__baseStyles.a": "useModifiedChildren__baseStyles.a",
    color: "x-831fxd",
    textDecoration: "x-1hl2dhg",
...
const Header = ({
  ...
  console.log(props$1, type, key);
  return jsxRuntimeExports.jsx("header", {
    ...props(baseStyles$1.header, className),
    children: modifiedChildren || children
  });
};
_inject2$1(".x-78zum5{display:flex}", 3000);
_inject2$1(".x-l56j7k{justify-content:center}", 3000);
const baseStyles$1 = {
  header: {
    "Header__baseStyles.header": "Header__baseStyles.header",
    display: "x-78zum5",
    justifyContent: "x-l56j7k",
    $$css: true
  }
};
...
const Block = ({
  ...
  return jsxRuntimeExports.jsx("div", {
    ...props(baseStyles.block, className),
    children: children
  });
};
_inject2(".x-h8yej3{width:100%}", 4000);
_inject2(".x-78zum5{display:flex}", 3000);
_inject2(".x-l56j7k{justify-content:center}", 3000);
const baseStyles = {
  block: {
    "Block__baseStyles.block": "Block__baseStyles.block",
    width: "x-h8yej3",
    display: "x-78zum5",
    justifyContent: "x-l56j7k",
    $$css: true
