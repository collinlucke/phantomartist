    ...
    buttons: ({ kind, size }) => {
        return {
            ...
            color: (kind === 'primary' && 'white') ||
                ...
                'inherit',
            backgroundColor: (kind === 'primary' && baseTheme.colors.secondary) ||
...
const Header = ({ children, className, propStyles }) => {
    return (jsx("header", { css: [baseStyles$5.header, propStyles], className: "pa-header", children: children }));
};
const baseStyles$5 = {
    header: {
        display: 'flex',
...
export { Block, Button, ButtonGroup, Form, FormInputLabel, FormTextArea, FormTextInput, Header, Image, InnerWidth, List, ListItem, Main, Search, TwoColumn, useResizedWidth };
