...
const Avatar = ({ displayName = 'Display Name', className, size = 40 }) => {
    ...
    return (jsx("div", { css: [getAvatarStyles(size), className?.avatar], children: jsxs("div", { css: [getInitialsStyles(size), className?.initials], children: [initials[0], initials[1]] }) }));
};
