...
const Avatar = ({ displayName = 'Display Name', className }) => {
    ...
    return (jsx("div", { css: [localStyles$2.avatar, className?.avatar], children: jsxs("div", { css: [localStyles$2.initials, className?.initials], children: [initials[0], initials[1]] }) }));
};
const localStyles$2 = {
    avatar: {
        borderRadius: '50%',
